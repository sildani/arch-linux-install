...
sed -i 's/of=\/dev\/sda/of=\/dev\/nvme1n1/; s/parted \/dev\/sda/parted \/dev\/nvme1n1/; s/\/dev\/sda1/\/dev\/nvme1n1p1/; s/\/dev\/sda2/\/dev\/nvme1n1p2/; s/\/dev\/sda3/\/dev\/nvme1n1p3/; s/29358079s/1945135103s/; s/29358080s 33554398s/1945135104s 1953525134s/' ~/arch-linux-install/01-partition-disk.sh
